#!/usr/bin/env bash
# train_basic 9000
for i in {1..20000}; do python run.py -w 10 -f 64 -l ko --output_dir out/basic; done;

# # train_skew 9000
# for i in {1..4500}; do python run.py -w 10 -f 64 -k 5 -rk -l ko --output_dir out/skew; done;
for i in {1..10000}; do python run.py -w 10 -f 64 -k 15 -rk -l ko --output_dir out/skew; done;
...
# for i in {1..5}; do python run.py -w 10 -f 64 -l ko -b 3 --output_dir out/back; done;